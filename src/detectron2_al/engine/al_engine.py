...
class ActiveLearningPredictor(DefaultPredictor):
    ...
    def __call__(self, original_image):
        ...
        with torch.no_grad():  # https://github.com/sphinx-doc/sphinx/issues/4258
            ...
            image = self.aug.get_transform(original_image).apply_image(original_image) # image = self.transform_gen.get_transform(original_image).apply_image(original_image)
